  ...
  return (
    <>
      ...
      <div className="mb-3 flex flex-wrap items-center justify-between gap-3 text-sm text-slate-300">
        <span>Preparing the SQL-backed operational overview.</span>
        <span className="rounded border border-cyan-400/30 bg-cyan-400/10 px-2 py-1 text-xs text-cyan-100">Historical replay is file-only</span>
      </div>
      <ReplayLivePanel />
    </>
  );
