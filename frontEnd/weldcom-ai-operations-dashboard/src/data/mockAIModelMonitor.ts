  ...
  kpis: [
    {
      ...
      tooltip: 'Aggregated status of model serving, the feature pipeline, the SQL contract, and scoring runtime.',
    },
    {
      ...
      tooltip: 'Share of eligible events with a complete window and an L1 score.',
    },
    {
      ...
      tooltip: 'Lenient is the production alert signal; strict is a sensitive early-warning signal.',
    },
    {
      ...
      tooltip: 'Aggregated positive prediction rate across fault, maintenance, and repair targets.',
    },
    {
      ...
      tooltip: 'Calibration health and thresholds currently applied by the production policy.',
    },
    {
      ...
      tooltip: 'Composite drift score across source data, features, scores, predictions, and KWh quality.',
    },
    {
      ...
      tooltip: 'Share of scoring runs completed successfully in the selected time range.',
    },
  ],
  l1Candidates: [
    {
      id: 'A', candidate: 'A – current model', note: 'Lenient – Production', production: true,
    ...
    {
      id: 'B', candidate: 'B – threshold-only change', note: 'Threshold-only candidate',
    ...
    {
      id: 'C', candidate: 'C – newly trained model', note: 'Candidate retrain',
