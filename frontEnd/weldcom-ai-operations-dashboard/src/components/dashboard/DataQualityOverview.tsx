  ...
  return (
    <section className="glass-panel panel-secondary data-quality-overview-card p-4">
      <div className="mb-3 flex items-center justify-between">
        <div className="panel-title metric-title-with-info">Data Quality Overview<DashboardInfoTooltip text="Completeness, timeliness, consistency, and accuracy of the event data used for scoring. These metrics measure data confidence, not machine health." /></div>
        <button className="text-sm font-semibold text-blue-400 hover:text-blue-200">View Details</button>
      </div>
