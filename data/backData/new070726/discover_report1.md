...
- Tables scanned: 7
- Total rows scanned: 541
- Total data size: 104,400 bytes
...
- `data_electric_cabinetglobal.csv` | rows=12 | size=2,868 bytes | kind=master_data
...
- **Machine operation state anomaly detection** | readiness=Low | score=0.0
- **Energy anomaly detection** | readiness=Low | score=0.0
...
- **data_cabinetglobal_kwh.cabinetglobal_id -> data_electric_cabinetglobal.id** | kind=direct_key | coverage=0.0
