...
```bash
E:\OBAD\inference\online\score_new_events.py --config inference/online/config.local.yaml --local-sql-write-canary --write-confirmation I_UNDERSTAND_THIS_WRITES_ONE_LOCAL_CANARY_EVENT --audit
```

## Nguồn dữ liệu

- Bảng event: `dbo.vw_ai_runtime_raw_iot_typed_local`
- Bảng online result chống duplicate: `dbo.ai_l2_fault_judgment_online_v2`

## Kết quả nhanh

- Raw candidate rows: 500
- Raw context rows: 526
- Processed rows: 500
