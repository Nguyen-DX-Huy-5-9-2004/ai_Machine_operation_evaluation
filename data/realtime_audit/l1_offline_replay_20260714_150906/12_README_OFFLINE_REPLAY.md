...
Thư mục audit: `G:\My Drive\OBAD\data\realtime_audit\l1_offline_replay_20260714_150906`

- Kết quả xác định raw snapshot: `EXACT_TRAINING_RAW_SNAPSHOT_FOUND`
- Kết quả parity transformation trên các event có raw input trùng: `PASS`
- Kết quả drift SQL hiện tại: `SOURCE_DATA_BACKFILLED`
- Kết luận: `L1_TRANSFORMATION_LOGIC_READY`
- Phân phối model: `MODEL_DISTRIBUTION_REVALIDATION_REQUIRED`
