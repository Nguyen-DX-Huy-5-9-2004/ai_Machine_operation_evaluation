...
```bash
E:\OBAD\inference\online\score_new_events.py --config inference/online/config.local.yaml --stage-only --audit --max-events 100
```
...
- Model readiness result: NOT_RUN_STAGE_ONLY
- Result: STAGE_ONLY_DATA_PIPELINE_PASS
